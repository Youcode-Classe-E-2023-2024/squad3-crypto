        ...
        <section class="section hero" aria-label="hero" data-section>
            <div class="container">
                ...
                <figure class="hero-banner">
                    <img src="{{ asset('assets/images/hero-banner.png') }}" width="570" height="448" alt="hero banner" class="w-100">
                </figure>
                    ...
                    <ul class="tab-content">
                        ...
                        <li>
                            <div class="trend-card">
                                ...
                                <div class="card-title-wrapper">
                                    <img src="{{ asset('assets/images/coin-1.svg') }}" width="24" height="24" alt="bitcoin logo">
                        ...
                        <li>
                            <div class="trend-card active">
                                ...
                                <div class="card-title-wrapper">
                                    <img src="{{ asset('assets/images/coin-2.svg') }}" width="24" height="24" alt="ethereum logo">
                        ...
                        <li>
                            <div class="trend-card">
                                ...
                                <div class="card-title-wrapper">
                                    <img src="{{ asset('assets/images/coin-3.svg') }}" width="24" height="24" alt="tether logo">
                        ...
                        <li>
                            <div class="trend-card">
                                ...
                                <div class="card-title-wrapper">
                                    <img src="{{ asset('assets/images/coin-4.svg') }}" width="24" height="24" alt="bnb logo">
                ...
                <div class="market-tab">
                    ...
                    <table class="market-table">
                        ...
                        <tr class="table-row">
                            ...
                            <td class="table-data">
                                <div class="wrapper">
                                    <img src="{{ asset('assets/images/coin-1.svg') }}" width="20" height="20" alt="Bitcoin logo" class="img">
                            ...
                            <td class="table-data">
                                <img src="{{ asset('assets/images/chart-1.svg') }}" width="100" height="40" alt="profit chart" class="chart">
                            </td>
                        ...
                        <tr class="table-row">
                            ...
                            <td class="table-data">
                                <div class="wrapper">
                                    <img src="{{ asset('assets/images/coin-2.svg') }}" width="20" height="20" alt="Ethereum logo" class="img">
                            ...
                            <td class="table-data">
                                <img src="{{ asset('assets/images/chart-2.svg') }}" width="100" height="40" alt="loss chart" class="chart">
                            </td>
                        ...
                        <tr class="table-row">
                            ...
                            <td class="table-data">
                                <div class="wrapper">
                                    <img src="{{ asset('assets/images/coin-3.svg') }}" width="20" height="20" alt="Tether logo" class="img">
                        ...
                        <tr class="table-row">
                            ...
                            <td class="table-data">
                                <div class="wrapper">
                                    <img src="{{ asset('assets/images/coin-4.svg') }}" width="20" height="20" alt="BNB logo" class="img">
                        ...
                        <tr class="table-row">
                            ...
                            <td class="table-data">
                                <div class="wrapper">
                                    <img src="{{ asset('assets/images/coin-5.svg') }}" width="20" height="20" alt="Solana logo" class="img">
                        ...
                        <tr class="table-row">
                            ...
                            <td class="table-data">
                                <div class="wrapper">
                                    <img src="{{ asset('assets/images/coin-6.svg') }}" width="20" height="20" alt="XRP logo" class="img">
                        ...
                        <tr class="table-row">
                            ...
                            <td class="table-data">
                                <div class="wrapper">
                                    <img src="{{ asset('assets/images/coin-7.svg') }}" width="20" height="20" alt="Cardano logo" class="img">
                        ...
                        <tr class="table-row">
                            ...
                            <td class="table-data">
                                <div class="wrapper">
                                    <img src="{{ asset('assets/images/coin-8.svg') }}" width="20" height="20" alt="Avalanche logo" class="img">
                ...
                <ul class="instruction-list">
                    ...
                    <li>
                        <div class="instruction-card">
                            ...
                            <figure class="card-banner">
                                <img src="{{ asset('assets/images/instruction-1.png') }}" width="96" height="96" loading="lazy" alt="Step 1"
                                     class="img">
                            </figure>
                    ...
                    <li>
                        <div class="instruction-card">
                            ...
                            <figure class="card-banner">
                                <img src="{{ asset('assets/images/instruction-2.png') }}" width="96" height="96" loading="lazy" alt="Step 2"
                                     class="img">
                            </figure>
                    ...
                    <li>
                        <div class="instruction-card">
                            ...
                            <figure class="card-banner">
                                <img src="{{ asset('assets/images/instruction-3.png') }}" width="96" height="96" loading="lazy" alt="Step 3"
                                     class="img">
                            </figure>
                    ...
                    <li>
                        <div class="instruction-card">
                            ...
                            <figure class="card-banner">
                                <img src="{{ asset('assets/images/instruction-4.png') }}" width="96" height="96" loading="lazy" alt="Step 4"
                                     class="img">
                            </figure>
        ...
        <section class="section about" aria-label="about" data-section>
            <div class="container">
                ...
                <figure class="about-banner">
                    <img src="{{ asset('assets/images/about-banner.png') }}" width="748" height="436" loading="lazy" alt="about banner"
                         class="w-100">
                </figure>
            ...
            <div class="container">
                ...
                <div class="app-content">
                    ...
                    <div class="app-wrapper">
                        <a href="#">
                            <img src="{{ asset('assets/images/googleplay.png') }}" width="135" height="40" loading="lazy"
                                 alt="get it on google play">
                        </a>

                        <a href="#">
                            <img src="{{ asset('assets/images/appstore.png') }}" width="120" height="40" loading="lazy"
                ...
                <div class="app-banner">
                    <img src="{{ asset('assets/images/app-banner.png') }}" width="618" height="526" loading="lazy" alt="app banner"
                         class="w-100">
            ...
            <div class="footer-top" data-section>
                <div class="container">
                    ...
                    <div class="footer-brand">
                        ...
                        <a href="#" class="logo">
                            <img src="{{ asset('assets/images/logo.svg') }}" width="50" height="50" alt="Cryptex logo">
                            Cryptex
                        </a>
