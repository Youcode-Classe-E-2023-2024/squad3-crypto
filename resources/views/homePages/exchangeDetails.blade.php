                            ...
                            <ul class="nav nav-pills">
                                ...
                                <li class="nav-item">
                                    <button class="nav-link etherum" id="nav-etherum-tab" data-bs-toggle="tab"
                                        data-bs-target="#nav-etherum" type="button"><svg width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                ...
                                <li class="nav-item">
                                    <button class="nav-link dash" id="nav-dash-tab" data-bs-toggle="tab"
                                        data-bs-target="#nav-dash" type="button"><svg width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                ...
                                <li class="nav-item">
                                    <button class="nav-link litcoin" id="nav-litcoin-tab" data-bs-toggle="tab"
                                        data-bs-target="#nav-litcoin" type="button"><svg width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                            ...
                                            <div class="d-flex mt-3 align-items-center">
                                                <div class="form-check custom-checkbox">
                                                    ...
                                                    <label class="form-check-label fs-14 font-w400 mt-1"
                                                        for="customCheckBox1">Lorem ipsum dolor sit amet, consectetur
                                            ...
                                            <div class="d-flex mt-3 align-items-center">
                                                <div class="form-check custom-checkbox">
                                                    <input type="checkbox" class="form-check-input" id="customCheckBox2"
                                                        required>
                                                    <label class="form-check-label fs-14 font-w400 mt-1"
                                                        for="customCheckBox2">Lorem ipsum dolor sit amet, consectetur
                                                        adipiscing elit, sed do eiusmod tempor incididunt ut</label>
                                                </div>
                                                <p class="mb-0"></p>
                                            </div>
