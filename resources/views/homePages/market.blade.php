                    ...
                    <div class="row">
                                    ...
                                    <div class="me-auto">
                                        ...
                                        <p class="mb-1 fs-13">
                                            <svg width="21" height="15" viewBox="0 0 21 15" fill="none"
                                                ...
                                                <defs>
                                                    <linearGradient x1="10.25" y1="3" x2="11"
                        ...
                        <div class="col-xl-3 col-xxl-3 col-lg-6 col-sm-6">
                            <div class="card trad-card overflow-hidden">
                                <div class="card-header border-0 pb-0 card-bx">
                                    <div class="me-auto">
                                        <h2 class="text-dark mb-2 font-w600">$2,551</h2>
                                        <p class="mb-1 fs-13">
                                            <svg width="21" height="15" viewBox="0 0 21 15" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path d="M1 13.5C1.91797 12.4157 4.89728 9.22772 6.5 7.5L12.5 10.5L19.5 1.5"
                        ...
                        <div class="col-xl-3 col-xxl-3 col-lg-6 col-sm-6">
                            <div class="card trad-card overflow-hidden">
                                <div class="card-header border-0 pb-0 card-bx">
                                    <div class="me-auto">
                                        <h2 class="text-dark mb-2 font-w600">$0,55</h2>
                                        <p class="mb-1 fs-13">
                                            <svg width="21" height="15" viewBox="0 0 21 15" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path d="M1 13.5C1.91797 12.4157 4.89728 9.22772 6.5 7.5L12.5 10.5L19.5 1.5"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="market-title d-flex align-items-center"
                                                            ...
                                                            <h5 class="mb-0 ms-2">{{ strtoupper($market['baseId']) }}</h5>
                                                            <span class="text-muted ms-2">{{ $market['baseSymbol']}}</span>
                                                        </a>
                                                    </td>
                                                    <td>${{ substr($market['priceQuote'], 0, 10)}}</td>
                                                    <td class="text-success">+{{substr($$market['percentExchangeVolume'], 0, 2)}}%</td>
