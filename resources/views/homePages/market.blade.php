                ...
                <div class="col-xl-12">
                    <div class="row">
                        <div class="col-xl-3 col-xxl-3 col-lg-6 col-sm-6">
                            <div class="card trad-card overflow-hidden">
                                <div class="card-header border-0 pb-0 card-bx">
                                    <div class="me-auto">
                                        <h2 class="text-dark mb-2 font-w600">${{ substr($cryptos[0]['priceUsd'], 0, 7) }}
                                        </h2>
                                        <p class="mb-1 fs-13">
                                           
                                           <span  @if ($cryptos[6]['changePercent24Hr'] < 0) style="color:red;" @else style="color:green;" @endif> {{ substr($cryptos[0]['changePercent24Hr'], 0, 4) }}%</span>(24 Hours)
                                        </p>
                                    </div>
                                    <img src="assets/images/svg/bitcoin-1.svg" alt="">
                                </div>
                        ...
                        <div class="col-xl-3 col-xxl-3 col-lg-6 col-sm-6">
                            <div class="card trad-card overflow-hidden">
                                <div class="card-header border-0 pb-0 card-bx">
                                    <div class="me-auto">
                                        <h2 class="text-dark mb-2 font-w600">${{ substr($cryptos[1]['priceUsd'], 0, 7) }}
                                        </h2>
                                        <p class="mb-1 fs-13">
                                           
                                           <span  @if ($cryptos[6]['changePercent24Hr'] < 0) style="color:red;" @else style="color:green;" @endif> {{ substr($cryptos[1]['changePercent24Hr'], 0, 4) }}%</span>(24 Hours)
                                        </p>
                                    </div>
                        ...
                        <div class="col-xl-3 col-xxl-3 col-lg-6 col-sm-6">
                            <div class="card trad-card overflow-hidden">
                                <div class="card-header border-0 pb-0 card-bx">
                                    <div class="me-auto">
                                        <h2 class="text-dark mb-2 font-w600">${{ substr($cryptos[6]['priceUsd'], 0, 7) }}
                                        </h2>
                                        <p class="mb-1 fs-13 ">
                                           <span  @if ($cryptos[6]['changePercent24Hr'] < 0) style="color:red;" @else style="color:green;" @endif> {{ substr($cryptos[6]['changePercent24Hr'], 0, 4) }}%</span>(24 Hours)
                                        </p>
                                    </div>
                        ...
                        <div class="col-xl-3 col-xxl-3 col-lg-6 col-sm-6">
                            <div class="card trad-card overflow-hidden">
                                <div class="card-header border-0 pb-0 card-bx">
                                    <div class="me-auto">
                                        <h2 class="text-dark mb-2 font-w600">${{ substr($cryptos[12]['priceUsd'], 0, 7) }}</h2>
                                        <p class="mb-1 fs-13">
                                          
                                           <span  @if ($cryptos[6]['changePercent24Hr'] < 0) style="color:red;" @else style="color:green;" @endif> {{ substr($cryptos[12]['changePercent24Hr'], 0, 4) }}%</span>(24 Hours)
                                        </p>
                                    </div>
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header flex-wrap border-0">
                            <h4 class="card-title mb-lg-0 mb-2">Market List</h4>
                            <ul class=" nav nav-pills light" id="pills-tab" role="tablist">
                                <li class="nav-item my-1" role="presentation">
                                    <button class="nav-link active" id="pills-crypto-tab" data-bs-toggle="pill"
                                        ...
                                        aria-controls="pills-crypto" aria-selected="true">All Markets
                                    </button>
                                </li>
                            </ul>
                        </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="market-title d-flex align-items-center"
                                                                ...
                                                                <h5 class="mb-0 ms-2">{{ strtoupper($market['baseId']) }}
                                                                </h5>
                                                                <span
                                                                    class="text-muted ms-2">{{ $market['baseSymbol'] }}</span>
                                                            </a>
                                                        </td>
                                                        <td class="text-success">
                                                            +{{ number_format($market['percentExchangeVolume'], 2) }}%</td>
                                                        <td>{{ number_format($market['priceUsd'], 2) }}</td>
                                                        <td>{{ $market['tradesCount24Hr'] }}</td>
                                                        <td>{{ floor($market['updated'] / (60 * 60 * 24)) }}</td>
                                                        <td class="text-end"><a href="{{ $market['quoteSymbol'] }}"
                                                                class="badge badge-sm badge-success">{{ $market['quoteSymbol'] }}</a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
